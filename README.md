...
backend/app/
  ...
  agent/                   Tool-calling agent (package)
    ...
    tools/                   The 22 @beta_tool data tools, split by concern:
                                ...
                                get_spending_by_geography (the six stay as
